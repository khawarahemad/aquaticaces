...
export const DOWNLOADS = [
  {
    ...
    file: '/downloads/aquaticaces-1.3.7.jar',
    size: '~500 KB',
    primary: true,
    icon: '⚡',
  },
...
export const INSTALL_STEPS = [
  ...
  },
  {
    ...
    body: 'Download aquaticaces-1.3.7.jar from this page and drop it into .minecraft/mods alongside Fabric API and Fabric Language Kotlin.',
  },
  {
    step: 6,
    title: 'Launch & Play',
